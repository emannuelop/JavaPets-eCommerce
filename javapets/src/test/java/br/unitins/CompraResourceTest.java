...
public class CompraResourceTest {
    ...
    public void getAllTest() {
        ...
        Usuario usuario = usuarioService.getByLogin("maria123");
    ...
    public void pagarBoletoBancarioTest() {
        ...
        ItemCompraDTO itemCompraDTO = new ItemCompraDTO(1l, 5);
    ...
    public void pagarPixTest() {
        ...
        ItemCompraDTO itemCompraDTO = new ItemCompraDTO(1l, 3);
    ...
    public void pagarCartaoCreditoTest() {
        ...
        ItemCompraDTO itemCompraDTO = new ItemCompraDTO(2l, 2);
